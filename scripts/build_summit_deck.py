#!/usr/bin/env python3
"""Generate BDC Summit deck for Extinction Archive (python-pptx)."""
...
def set_body_font(text_frame, size_pt=18):
...
def main():
    ...
    add_bullets(
        ...
        [
            "Team: 2 members — Experience Lead (narrative, ethics, science translation) + Tech/AI Lead (WebXR, generative env, epistemic UI).",
